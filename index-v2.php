		...
		<div id="header-gradient">
			...
			<div id="header-logo-container">
				...
				<div id="header-logo-right">
					<div class="advertisement"><a href="http://themeforest.net/user/ProgressionStudios?ref=ProgressionStudios" target="_blank"><img src="images/demo-content/advertisement.png" alt="Ad" width="468" height="60"></a></div>
		...
		<div class="content-container">
			...
			<div id="showcase" class="showcase">
				...
				<div class="showcase-slide">
					<div class="showcase-content">
						...
						<div class="slider-right">
							<h2><a href="#">Lamborghini Aventador</a></h2>
				...
				<div class="showcase-slide">
					<div class="showcase-content">
						<div class="slider-left">
							<iframe width="560" height="315" src="http://www.youtube.com/embed/wTvtheJkthc?hd=1&wmode=opaque" frameborder="0" allowfullscreen></iframe>
						</div><!-- close .slider-left -->
						<div class="slider-right">
							<h2><a href="#">911 Black Edition</a></h2>
							<div class="post-details-slider">by <a href="#">Michael Garcia</A> on <a href="#">Jan 29 2011</a></div>
							<p>Lorem ipsum dolor sit amet, consectetur adipis cing elit. Ut imperdiet facilisis facilisis. Vesti bulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilias...</p>
							<div class="more-link-slider"><a href="" class="button">Watch Now &rsaquo;</a> <span>or <a href="#">Join Discussion</a></span></div>
						</div><!-- close .slider-right -->
				...
				<div class="showcase-slide">
					<div class="showcase-content">
						<div class="full-width-slide">
							<img src="images/demo-content/slider1.jpg" width="900" height="315" alt="image" />
				...
				<div class="showcase-slide">
					<div class="showcase-content">
						<div class="full-width-slide">
							<iframe src="http://player.vimeo.com/video/8839502?title=0&amp;byline=0&amp;portrait=0" width="900" height="315" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe>
						</div><!-- close .full-width-slide -->
					</div>
				</div>
				<!-- END SLIDE .showcase-slide-->
		...
		<div class="content-container">
			...
			<div class="tabs">
		        <ul class="tabNavigation">
		            <li><a href="#latest-videos">Latest Videos</a></li>
					<div class="clearfix"></div>
		        </ul>
		        <div id="latest-videos">
		            <div class="grid3column">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio12.png" width="280" height="212" alt="" />
						</div>
					...
					<div class="grid3column">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio13.jpg" width="280" height="212" alt="" class="transparent-icon" />
						</div>
					...
					<div class="grid3column lastcolumn">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio14.png" width="280" height="212" alt="" class="transparent-icon" />
						</div>
					...
					<div class="grid3column">
						<div class="portfolio-list">
						<iframe src="http://player.vimeo.com/video/6686768?title=0&byline=0&portrait=0" width='280' height='212' frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
					...
					<div class="grid3column">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio15.png" width="280" height="212" alt="" class="transparent-icon" />
						</div>
					...
					<div class="grid3column lastcolumn">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio16.jpg" width="280" height="212" alt="" class="transparent-icon" />
						</div>
					...
					<div class="grid3column">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio17.png" width="280" height="212" alt="" />
						</div>
						<h5><a href="portfolio-single.php">Nitro Circus The Movie</a></h5>
						<p>by Mike on January 23, 2012</p>
						</div><!-- close .portfolio-list -->
					</div>
					<div class="grid3column">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio18.png" width="280" height="212" alt="" class="transparent-icon" />
						</div>
					...
					<div class="grid3column lastcolumn">
						...
						<div class="gallery-hover">
							...
							<img src="images/demo-content/portfolio19.png" width="280" height="212" alt="" class="transparent-icon" />
						</div>
					...
					<div class="home-page-older"><a href="#">Older Entries &rsaquo;</a></div>
