...
<body>
	...
	<div id="main" role="main">	
		...
		<div class="bread-crumbs"><span>You are here:</span>  <a href="index.php">Home</a> &rsaquo; Sidebar Left</div>
		
		
		<div class="content-container">
			
			<div class="sidebar-container container-left">
				
			<div class="page-content content-sidebar-left">
				...
				<p>The sidebar left is achieved via these three classes "<strong>container-left</strong>", "<strong>content-sidebar-left</strong>", "<strong>sidebar-left</strong>", and "<strong>side-bar-base-left</strong>".</p>
				
				
				
				<p>This is a sample column layout. You will also find various column layout examples that should help you out.</p>
		...
		<div class="content-container-base">
			<div class="side-bar-base side-bar-base-left"></div>
