...
<body>
	...
	<div id="main" role="main">	
		...
		<div class="bread-crumbs"><span>You are here:</span>  <a href="index.php">Home</a> &rsaquo; Portfolio One Column Sidebar</div>
		...
		<div class="content-container">
			...
			<div class="page-content content-sidebar">
				<h1 class="page-title">Portfolio One Column Sidebar</h1>
				...
				<div class="grid-full-column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio24.jpg" width="630" height="200" alt="" />
					</span>
				...
				<div class="grid-full-column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio25.png" width="630" height="200" alt="" />
					</span>
				...
				<div class="grid-full-column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio26.png" width="630" height="200" alt="" />
					</span>
				...
				<div class="grid-full-column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio27.jpg" width="630" height="200" alt="" />
					</span>
