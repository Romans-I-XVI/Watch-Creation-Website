...
<body>
	...
	<div id="main" role="main">	
		...
		<div class="bread-crumbs"><span>You are here:</span>  <a href="index.php">Home</a> &rsaquo; Portfolio Two Column Sidebar</div>
		...
		<div class="content-container">
			...
			<div class="page-content content-sidebar">
				<h1 class="page-title">Portfolio Two Column Sidebar</h1>
				...
				<div class="grid2column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio20.png" width="300" height="226" alt="" />
					</span>
				...
				<div class="grid2column lastcolumn">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio20.jpg" width="300" height="226" alt="" class="transparent-icon" />
					</span>
