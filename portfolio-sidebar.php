...
<body>
	...
	<div id="main" role="main">	
		...
		<div class="bread-crumbs"><span>You are here:</span>  <a href="index.php">Home</a> &rsaquo; Portfolio Sidebar</div>
			...
			<div class="page-content content-sidebar">
				...
				<div class="grid4column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio1.png" width="135" height="102" alt="" />
					</span>
				...
				<div class="grid4column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio2.jpg" width="135" height="102" alt="" class="transparent-icon" />
					</span>
					<h5><a href="portfolio-single.php">Photo - Yosemite</a></h5>
				...
				<div class="grid4column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio3.png" width="135" height="102" alt="" class="transparent-icon" />
					</span>
					<h5><a href="portfolio-single.php">Inner Secrets</a></h5>

					</div><!-- close .portfolio-list -->
				</div>
				<div class="grid4column lastcolumn">
					<div class="portfolio-list">
					<iframe src="http://player.vimeo.com/video/6686768?title=0&amp;byline=0&amp;portrait=0" width='135' height='102' frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
				...
				<div class="grid4column">
					<div class="portfolio-list">
						<span class="gallery-hover">
							...
							<img src="images/demo-content/portfolio4.png" width="135" height="102" alt="" class="transparent-icon" />
						</span>
				...
				<div class="grid4column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio5.jpg" width="135" height="102" alt="" class="transparent-icon" />
					</span>
				...
				<div class="grid4column">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio6.png" width="135" height="102" alt="" class="transparent-icon" />
					</span>
				...
				<div class="grid4column lastcolumn">
					...
					<span class="gallery-hover">
						...
						<img src="images/demo-content/portfolio7.png" width="135" height="102" alt="" class="transparent-icon" />
					</span>
